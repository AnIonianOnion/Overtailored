...
//copy of https://github.com/phuccom000/Overgeared/blob/1.21.1/src/main/java/net/stirdrem/overgeared/client/AnvilMinigameOverlay.java
@OnlyIn(Dist.CLIENT)
public class AnvilMinigameOverlay implements LayeredDraw.Layer {
    ...
    public static final ResourceLocation ID = OvertailoredMod.loc("anvil_minigame");

    private static final ResourceLocation TEXTURE =
            OvertailoredMod.loc("textures/gui/smithing_anvil_minigame.png");
