...
//copy of https://github.com/phuccom000/Overgeared/blob/1.21.1/src/main/java/net/stirdrem/overgeared/client/OvergearedConfigScreen.java
@OnlyIn(Dist.CLIENT)
public class OvertailoredConfigScreen extends Screen {
    ...
    public OvertailoredConfigScreen(Screen parent) {
        super(Component.literal("Overtailored Configuration"));
        this.parent = parent;
        loadConfig();
    }
    ...
    public void onClose() {
        ...
        if (configFile != null) {
            try {
                ...
                OvertailoredMod.LOGGER.error("Error closing config file", e);
            }
        }
    }
    ...
    private void save() {
        try {
          ...
          OvertailoredMod.LOGGER.error("Failed to save config", e);
        }
    }
...
// --- Config Get/Set Helpers ---
    ...
    private class BlacklistEntry extends ConfigList.ConfigEntry {
        ...
        private void openBlacklistEditor(String blacklistName, List<? extends String> currentItems) {
            ...
            Minecraft mc = OvertailoredConfigScreen.this.minecraft;
