package com.anionianonion.overtailored.networking;
...
public class ModNetworkHandler {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        final PayloadRegistrar registrar = event.registrar(OvertailoredMod.MOD_ID);
        ...
        registrar.playToServer(
                SelectArmorTypeC2SPacket.TYPE,
                SelectArmorTypeC2SPacket.STREAM_CODEC,
                SelectArmorTypeC2SPacket::handle
        );
