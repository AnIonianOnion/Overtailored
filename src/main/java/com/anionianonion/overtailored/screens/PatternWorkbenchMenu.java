...
//copy of https://github.com/phuccom000/Overgeared/blob/1.21.1/src/main/java/net/stirdrem/overgeared/screen/BlueprintWorkbenchMenu.java
public class PatternWorkbenchMenu extends AbstractContainerMenu {
    private final Container inputContainer;
    private final Container outputContainer;
    private final ContainerData data;

    public PatternWorkbenchMenu(int containerId, Inventory playerInventory) {
    ...
    public PatternWorkbenchMenu(int containerId, Inventory playerInventory,
                                ...
                                ContainerData data) {
        super(ModMenuTypes.PATTERN_WORKBENCH_MENU.get(), containerId);
        ...
        this.addSlot(new Slot(inputContainer, 0, 48, 35) {
            ...
            public boolean mayPlace(ItemStack stack) {
                return stack.is(ModItems.EMPTY_PATTERN.get());
            }
        });
    ...
    public void createBlueprint(ArmorType armorType) {
        ItemStack input = this.inputContainer.getItem(0);
        if (!input.is(ModItems.EMPTY_PATTERN.get()) || input.isEmpty()) {
            return;
        }
        ...
        if (output.isEmpty()) {
            ItemStack newOutput = new ItemStack(ModItems.CLOTHES_PATTERN.get());
            newOutput.set(ModComponents.PATTERN_DATA, new PatternData(
                    PatternQuality.WELL.name(),
                    armorType.getId(),
                    0,
                    PatternQuality.WELL.getUse()));
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot.hasItem()) {
            ...
            else if (itemstack1.is(ModItems.EMPTY_PATTERN.get())) {
